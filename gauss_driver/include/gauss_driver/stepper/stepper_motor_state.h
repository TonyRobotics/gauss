#ifndef GAUSS_STEPPER_MOTOR_STATE_H
#define GAUSS_STEPPER_MOTOR_STATE_H
...
class StepperMotorState {
    ...
    public:
        ...
        StepperMotorState(const std::string name, int id, double gear_ratio, double direction, 
                int32_t home_position, int32_t offset_position, uint8_t micro_steps, uint16_t max_effort) {
            this->name = name;
            this->id = id;
        ...
        uint16_t getMaxEffortCommand()     { return cmd_max_effort; }
