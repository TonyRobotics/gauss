...
#ifndef GAUSS_CAN_COMMUNICATION_H
#define GAUSS_CAN_COMMUNICATION_H 
...
#include "gauss_driver/stepper/stepper_motor_state.h"
...
#define CAN_MOTOR_2_ID 2       // Those ids need to be used in gauss_motors.yaml to enable/disable some stepper motors
...
class CanCommunication {
    ...
    private:
        ...
        boost::shared_ptr<GaussCanDriver> can;
        ...
        StepperMotorState m4; // NOT used for Gauss V2
