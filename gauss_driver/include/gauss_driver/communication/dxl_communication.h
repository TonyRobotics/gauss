...
#include "gauss_driver/dynamixel/dxl_motor_state.h"
#include "gauss_driver/dynamixel/xl320_driver.h"
#include "gauss_driver/dynamixel/xl430_driver.h"
...
class DxlCommunication {
    ...
    private:
        ...
        bool stop_gripper_enable;

        std::mutex gripper_command_mutex;
        bool is_gripper_opening;
        bool is_gripper_closing;
};
