...
FakeCommunication::FakeCommunication(int hardware_version)
{
    ...
    ros::param::get("/gauss/motors/stepper_1_home_position", pos_0);
    ros::param::get("/gauss/motors/stepper_2_home_position", pos_1);
    ros::param::get("/gauss/motors/stepper_3_home_position", pos_2);
   
    if (hardware_version == 1) {
        double pos_3;
        ros::param::get("/gauss/motors/stepper_4_home_position", pos_3);
